dic = {'Ә':'Ä','ә':'ä','і':'ı','І':'I','ң':'ñ','Ң':'Ñ', 'ғ':'ğ', 'Ғ':'Ğ', 'ү':'ü', 'Ү':'Ü', 'Ұ':'Ū', 'ұ':'ū', 'қ':'q', 'Қ':'Q', 'ө':'ö', 'Ө':'Ö', 'һ':'H ', 'Һ':'h', 'Ь':'', 'ь':'', 'Ъ':'', 'ъ':'', 'А':'A', 'а':'a', 'Б':'B', 'б':'b', 'В':'V', 'в':'v',
...
alphabet = ['Ә','ә','і','І','ң','Ң', 'ғ', 'Ғ', 'ү', 'Ү', 'Ұ', 'ұ', 'қ', 'Қ', 'ө', 'Ө', 'һ', 'Һ', 'Ь', 'ь', 'Ъ', 'ъ', 'А', 'а', 'Б', 'б', 'В', 'в', 'Г', 'г', 'Д', 'д', 'Е', 'е', 'Ё', 'ё',
